...
Few turns below the Tin street you come across a rubble filled corridor. Even
though it is filled with debrie, you see a large amount of footprints.

"Halt! Goblin on guard!"
"Stop! Turn around and mind your business!"
"(Unsheathes his weapon) You are violating my orders! Prepare to fight!"

A single goblin by the name of Grxtract is upset by his death. He calls out to
anyone aproaching him, to stay away, before engaging in combat. He claims that
his death was organised and he wants a proper claim in courts of Azorius. He
has a family of seven children and a wife that is still pregnant by his memory.
He claims that his life was taken in directed assasination and requires a wojek
to investigate it. Goblin wields a faint Boros insignia on his chest. He is
armed with a shield and a scimitar.

If asked what the ghost is doing here, he responds that he was placed on guard.
If asked what he is guarding, ghost simply screams "DO NOT COME ANY CLOSER! Or I
will be forced to take you down!"

If the party tries to bypass him, he goes into nercomantic rage and attacks,
his orders are to let no creatures pass.

His wife is already dead. His ghost was returned to plane of Ravnica by a
necromancer Gus Ler, who wishes to protect an infestation of vegepygmys. One of
the Mizzium Brothers is the latest son of Grxtract. He now goes by the name of
Yrtrzx. His father's ghost hints that his latest son is the smartest of the
lot. Even in his young age he should have joined Izzet.

An infestation can be combated or reported. Infestation is growing in number of
connected chambers which eventualy lead to drain cistern. Each chamber contains
some living mushrooms, doing their day to day work, like tending the bigger
shrooms or harvesting the warmth from Izzet plumbing.
...
party. There are number of dangerous creatures apart from Vegepygmy guards.
Violet Fungus, Shriekers and the like. The chamber is unlit, there are only
some sprinkles of light from fluorescent spores floating in the air.

X [Shriekers](https://www.dndbeyond.com/monsters/shrieker)
X [Fungus](https://www.dndbeyond.com/monsters/violet-fungus)

1 [Ghost](https://www.dndbeyond.com/monsters/ghost)

6 [Vegepygmy Tribesman](https://www.dndbeyond.com/monsters/vegepygmy)
2 [Thorny](https://www.dndbeyond.com/monsters/thorny)
...
- Armid
  Viashino scout.
  "I am no trouble. I go, sell pretty stone, return. No harm, good for clan."
...
- Tamid Luade
  ...
  "Oh, very well, I am glad you have come. I have a bit of an issue in my hands, I almost
  have a claim ready for the Chamber of the Guildpact, but I lack proper evidence. I have done
  the interogation myself, but this Linda is foul being and refuses her guilt. Can you find
  evidence of cross-guild feud and bring that to me? I will pay in platinum."
...
- Linda Moisuz
  ...
  "This is all a big missunderstanding. I have no wish to meddle with the
  guildpact. I was just doing my job. Mortimer came to me with a proposal and
  decent amount of coin. I filled my part of the contract. It is none of my
  business that the zombies come too close to the plants! Please, go talk to
  Mortimer Lan, you can find him next to Transguild Promenade in Plaza South.
  He has a small office there."

- Mortimer Lan
  Deal maker between Linda and Golgari. He is slender, he has black eyes and
  thin lips. He wears a well tailored suit. There is a noticable rash coming
  out from his collar on his neck. He is affiliated with Orzhov, his mother in
  law is related to a true blood pontif. He is trying to find efforts that
  would bring him in favour with the guild. He claims that the deal was fair.
  Golgari wanted the waspcrabs taken care of. Side effect of plants atacking
  zombie workforce is not covered in his contracts. He wishes to take care of
  this manner with minimal cost. When pressed he can cover extra payment for
  each violent greyflowers. But he wishes to trade favour for it instead.

  "I negotiated this deal. That is correct. I did not expect Linda's creation
  to disrupt Golgari work. We would have resolved this issue already if not for
  that corrupted field officer. Look, I must not have this issue taint neither
  ...
  Make three combat encounters. With at least one large flower bulb
  that sprouts other flowers. First combat encounter introduces 1 flower, so players may gauge
  it's power. Second introduces 6 flowers, so that all abilities are shown. Third
  encounter has endless amount of flowers, comming in small waves. In the distance players
  see a huge bulb, which spits seeds around it.

  Bulb itself has no protection, but it has enormous amount of health.
  ...
  Seed sprout (recharge 5-6) Fires 2d6 seeds around the players.
  Seeds take 1 turns to fully sprout into Spitting Greyflower Sappling.

  [Spitting Greyflower Sappling]

  Hit points 2d6+4

  Actions:

  Chomp. Melee Weapon Attack: +4 to hit, reach 5 ft., one target. Hit:
  2 (1d4) slashing damage plus 6 (2d4+2) acid damage.

  Spit. Ranged Weapon Attack: +4 to hit, range 30/60 ft., one target. Hit: 4
  (1d4 + 2) acid damage.
